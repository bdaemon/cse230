...
{-@ type NewStore G V = {g:Store | newStore G V g} @-}
{-@ inline newStore @-}
newStore :: Store -> Variable -> Store -> Bool
newStore g1 v g2 = setVars g2 == setVars g1 `S.union` S.singleton v

{-@ update :: g1:Store -> v:Variable -> Value -> NewStore g1 v @-}
...
case1 =
     (Assign "I" (Val 1))
     `Sequence`
     (WhileZ (Val 1) (Assign "X" (Var "I")))

case2 =
     (Assign "I" (Val 1))
     `Sequence`
     (WhileZ (Val 0) (Assign "X" (Var "I")))
...
case5 =
     (WhileZ (Val 1) (Assign "X" (Val 1)))
     `Sequence`
     (Assign "I" (Var "X"))

case6 =
     (WhileZ (Val 0) (Assign "X" (Val 1)))
     `Sequence`
     (Assign "I" (Var "X"))
...
case8 =
     (Assign "I" (Val 2))
     `Sequence`
     (Assign "I" (Op Plus (Var "I") (Val 3)))
     `Sequence`
     (IfZ (Val 1) ((Assign "X" (Val 0)) `Sequence` (Assign "Y" (Val 1))) ((Assign "Y" (Var "I")) `Sequence` (Assign "X" (Val 1))))
     `Sequence`
     (Assign "Z" (Op Minus (Var "X") (Var "Y")))
